                                ...
                                <div class="row gy-4">
                                    <div class="col-md-4">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <input type="text" name="ten_quan_tri" id="ten_quan_tri" placeholder="Nhập tên nhân viên"
                                                class="form-control @error('ten_quan_tri') is-invalid @enderror" value="{{$taikhoan->ten_quan_tri}}">
                                            @error('ten_quan_tri')
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <input type="text" name="sdt" id="sdt" placeholder="Nhập số điện thoại"
                                                class="form-control @error('sdt') is-invalid @enderror" value="{{$taikhoan->sdt}}">
                                            @error('sdt')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <input type="email" name="email" id="email" placeholder="Nhập email"
                                                class="form-control @error('email') is-invalid @enderror" value="{{$taikhoan->email}}">
                                            @error('email')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="mt-3">
                                            ...
                                            <img src="{{ Storage::url($taikhoan->anh_dai_dien) }}" class="img-thumbnail" alt="Ảnh đại diện" width="100px">
                                            @error('anh_dai_dien')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mt-3 text-center">
                                            <button class="btn btn-primary" type="submit">Cập nhật mới</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
