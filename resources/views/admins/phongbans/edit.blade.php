                ...
                <div class="h-100">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Form sửa </h4>
                        </div><!-- end card header -->

                        <div class="card-body">
                            <div class="live-preview">
                                <form action="{{ route('phongban.update',$phongbans->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row gy-4">
                                        <div class="col-md-4">
                                            ...
                                            <div class="mt-3">
                                                <label for="ten_phong_ban" class="form-label">Tên phòng ban</label>
                                                <input type="text" name="ten_phong_ban" id="ten_phong_ban"
                                                    placeholder="Nhập tên phong ban"
                                                    class="form-control @error('ten_phong_ban') is-invalid @enderror"
                                                    value="{{ $phongbans->ten_phong_ban}}">
                                                @error('ten_phong_ban')
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <input type="text"  name="mo_ta"
                                                    ...
                                                    placeholder="mo_ta" value="{{ $phongbans->mo_ta }}">
                                                @error('mo_ta')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                            </div>
                                                ...
                                                <div class="mt-3 text-center">
                                                    <button class="btn btn-primary" type="submit">Sửa</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
