...
<div class="container mt-4">
    ...
    <div class="card p-4 shadow-sm">
        <form action="{{ route('bangluong.update', $bangLuong->id) }}" method="POST">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="number" name="tien_thuong" class="form-control" step="1000" min="0" value="{{$bangLuong->tien_thuong}}">
            </div>
