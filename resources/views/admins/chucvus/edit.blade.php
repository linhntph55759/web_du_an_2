                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <form action="{{ route('chucvu.update',$chucvus->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row gy-4">
                                        <div class="col-md-4">
                                            ...
                                            <div class="mt-3">
                                                <label for="ten_chuc_vu" class="form-label">Tên nhân viên</label>
                                                <input type="text" name="ten_chuc_vu" id="ten_chuc_vu"
                                                    placeholder="Nhập tên chức vụ"
                                                    class="form-control @error('ten_chuc_vu') is-invalid @enderror"
                                                    value="{{ $chucvus->ten_chuc_vu}}">
                                                @error('ten_chuc_vu')
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <input type="text"  name="mo_ta"
                                                    ...
                                                    placeholder="mo_ta" value="{{ $chucvus->mo_ta }}">
                                                @error('mo_ta')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                            </div>
