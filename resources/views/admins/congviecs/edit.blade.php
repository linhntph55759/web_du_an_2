                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="live-preview">
                            <form action="{{ route('congviec.update',$congviec->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @METHOD('PUT')
                                <div class="row gy-4">
                                    <div class="col-md-4">
                                        <div class="mt-3">
                                            ...
                                            <input type="text" name="ten_cong_viec" id="ten_cong_viec" placeholder="Nhập tên công việc"
                                                class="form-control @error('ten_cong_viec') is-invalid @enderror" value="{{$congviec->ten_cong_viec }}">
                                            @error('ten_cong_viec')
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <input type="number" name="muc_luong" id="muc_luong" placeholder="Nhập muc luong"
                                                class="form-control @error('muc_luong') is-invalid @enderror" value="{{ $congviec->muc_luong }}">
                                            @error('muc_luong')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <input type="text" name="ca_lam" id="ca_lam" placeholder="Nhập ca làm"
                                                class="form-control @error('ca_lam') is-invalid @enderror" value="{{$congviec->ca_lam}}">
                                            @error('ca_lam')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <select name="id_chuc_vu" id="id_chuc_vu" class="form-control @error('id_chuc_vu') is-invalid @enderror" >
                                                ...
                                                @foreach($chucVus as $chucVu)
                                                    <option value="{{ $chucVu->id }}"{{old('id_chuc_vu',$congviec->id_chuc_vu) == $chucVu->id ? 'selected' : '' }}>
                                                        {{ $chucVu->ten_chuc_vu }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            ...
                                            <select name="id_phong_ban" id="id_phong_ban" class="form-control @error('id_phong_ban') is-invalid @enderror">
                                                ...
                                                @foreach($phongBans as $phongBan)
                                                    <option value="{{ $phongBan->id }}"
                                                        {{ old('id_phong_ban', $congviec->id_phong_ban) == $phongBan->id ? 'selected' : '' }}>
